...
;(function($, window, document, undefined) {
    ...
    NivoLightbox.prototype = {
        ...
        showLightbox: function(e) {
            ...
            // Nav
            if (this.$el.attr('data-lightbox-Roadmap')) {
                var RoadmapItems = $('[data-lightbox-Roadmap="' + this.$el.attr('data-lightbox-Roadmap') + '"]');
                ...
                $('.nivo-lightbox-prev').off('click').on('click', function(e) {
                    e.preventDefault();
                    var index = RoadmapItems.index(currentLink);
                    currentLink = RoadmapItems.eq(index - 1);
                    if (!$(currentLink).length)
                        currentLink = RoadmapItems.last();
                ...
                $('.nivo-lightbox-next').off('click').on('click', function(e) {
                    ...
                    currentLink = RoadmapItems.eq(index + 1);
                    if (!$(currentLink).length)
                        currentLink = RoadmapItems.first();
