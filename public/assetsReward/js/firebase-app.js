!function(t, e) {
    ...
    : function(t, e, r) {
      ...
      , F = e(function(t) {
        ...
        (t.exports = function(t, r, o, i) {
            ...
            s && (P(o, "name") || A(o, "name", r)),
            t[r] !== o && (s && (P(o, e) || A(o, e, t[r] ? "" + t[r] : n.join(String(r)))),
            t === h ? t[r] = o : i ? t[r] ? t[r] = o : A(t, r, o) : (delete t[r],
            A(t, r, o)))
        }
      ...
      , N = function(t, e, r) {
        var n, o, i, s, a = t & N.F, u = t & N.G, c = t & N.S, f = t & N.P, p = t & N.B, d = u ? h : c ? h[e] || (h[e] = {}) : (h[e] || {}).prototype, y = u ? l : l[e] || (l[e] = {}), v = y.prototype || (y.prototype = {});
        for (n in u && (r = e),
        r)
            i = ((o = !a && d && void 0 !== d[n]) ? d : r)[n],
            s = p && o ? L(i, h) : f && "function" == typeof i ? L(Function.call, i) : i,
            d && F(d, n, i, t & N.U),
            y[n] != i && A(y, n, s),
            f && v[n] != i && (v[n] = i)
    };
    ...
    var D = N
      ...
      , Y = function(t, e) {
        return new (function(t) {
            var e;
            return V(t) && ("function" != typeof (e = t.constructor) || e !== Array && !V(e.prototype) || (e = void 0),
            p(e) && null === (e = e[J]) && (e = void 0)),
            void 0 === e ? Array : e
        }(t))(e)
    }
      , X = function(t, e) {
    ...
    var it, st = function(t) {
        return B(C(t))
    }, at = Math.max, ut = Math.min, ct = K("keys"), ft = function(t) {
        return ct[t] || (ct[t] = x(t))
    }, ht = (it = !1,
    function(t, e, r) {
        var n, o = st(t), i = H(o.length), s = function(t, e) {
    ...
    ), lt = ft("IE_PROTO"), pt = function(t, e) {
        var r, n = st(t), o = 0, i = [];
        for (r in n)
            r != lt && P(n, r) && i.push(r);
        for (; e.length > o; )
            P(n, r = e[o++]) && (~ht(i, r) || i.push(r));
        return i
    }, dt = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(","), yt = Object.keys || function(t) {
        return pt(t, dt)
    }
    , vt = {
    ...
    }, mt = Object.assign, _t = !mt || y(function() {
        var t = {}
          , e = {}
          , r = Symbol()
        ...
        for (var r = U(t), n = arguments.length, o = 1, i = vt.f, s = bt.f; n > o; )
            for (var a, u = B(arguments[o++]), c = i ? yt(u).concat(i(u)) : yt(u), f = c.length, h = 0; f > h; )
    ...
    var gt = $("match")
      , wt = function(t, e, r) {
        if (p(n = e) && (void 0 !== (o = n[gt]) ? o : "RegExp" == R(n)))
    ...
    S.f)
      ...
      , Rt = function() {
        ...
        t.close(),
        Rt = t.F; r--; )
            delete Rt.prototype[dt[r]];
        return Rt()
    }
      , Bt = Object.create || function(t, e) {
        var r;
        return null !== t ? (It.prototype = d(t),
        r = new It,
        It.prototype = null,
        r[Dt] = t) : r = Rt(),
        void 0 === e ? r : Ft(r, e)
    ...
    : function(t) {
      ...
      , le = function(t, e, r) {
        return t === ie && le(oe, e, r),
        d(t),
        e = w(e, !0),
        d(r),
        P(ne, e) ? (r.enumerable ? (P(t, Zt) && t[Zt][e] && (t[Zt][e] = !1),
        r = Bt(r, {
            enumerable: E(0, !1)
        })) : (P(t, Zt) || $t(t, Zt, E(1, {})),
        t[Zt][e] = !0),
      ...
      , pe = function(t, e) {
        ...
        for (var r, n = function(t) {
            var e = yt(t)
              , r = vt.f;
            if (r)
                for (var n, o = r(t), i = bt.f, s = 0; o.length > s; )
                    i.call(t, n = o[s++]) && e.push(n);
            return e
        }(e = st(e)), o = 0, i = n.length; i > o; )
            le(t, r = n[o++], e[r]);
        return t
    }
      , de = function(t) {
      ...
      , ye = function(t, e) {
        ...
        t !== ie || !P(ne, e) || P(oe, e)) {
            var r = Kt(t, e);
            return !r || !P(ne, e) || P(t, Zt) && t[Zt][e] || (r.enumerable = !0),
            r
        }
    }
      , ve = function(t) {
        for (var e, r = Jt(st(t)), n = [], o = 0; r.length > o; )
            P(ne, e = r[o++]) || e == Zt || e == qt || n.push(e);
        return n
    }
      , be = function(t) {
        for (var e, r = t === ie, n = Jt(r ? oe : st(t)), o = [], i = 0; n.length > i; )
            !P(ne, e = n[i++]) || r && !P(ie, e) || o.push(ne[e]);
        return o
    };
    se || (F((Yt = function() {
        ...
        var t = x(arguments.length > 0 ? arguments[0] : void 0)
          , e = function(r) {
            this === ie && e.call(oe, r),
            P(this, Zt) && P(this[Zt], t) && (this[Zt][t] = !1),
            ce(this, t, E(1, r))
        };
        return v && ue && ce(ie, t, {
            configurable: !0,
    ...
    bt.f = de,
    vt.f = be,
    v && F(ie, "propertyIsEnumerable", de, !0),
    Tt.f = function(t) {
        return fe($(t))
    }
    ),
    ...
    for (var me = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), _e = 0; me.length > _e; )
        $(me[_e++]);
    for (var ge = yt($.store), we = 0; ge.length > we; )
        xt(ge[we++]);
    D(D.S + D.F * !se, "Symbol", {
        for: function(t) {
    ...
    Yt.prototype[te] || A(Yt.prototype, te, Yt.prototype.valueOf),
    Pt(Yt, "Symbol"),
    Pt(Math, "Math", !0),
    Pt(h.JSON, "JSON", !0);
    var Oe = $("toStringTag")
      ...
      , Ee = {};
    Ee[$("toStringTag")] = "z",
    Ee + "" != "[object z]" && F(Object.prototype, "toString", function() {
    ...
    var Pe, Te = function(t, e, r) {
        ...
        Pt(t, e + " Iterator")
    }, ke = ft("IE_PROTO"), xe = Object.prototype, Fe = Object.getPrototypeOf || function(t) {
        return t = U(t),
        P(t, ke) ? t[ke] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? xe : null
    }
    , Le = $("iterator"), Ne = !([].keys && "next"in [].keys()), De = function() {
        return this
        ...
        }, h = e + " Iterator", l = "values" == o, p = !1, d = t.prototype, y = d[Le] || d["@@iterator"] || o && d[o], v = y || f(o), b = o ? l ? f("entries") : v : void 0, m = "Array" == e && d.entries || y;
        if (m && (c = Fe(m.call(new t))) !== Object.prototype && c.next && (Pt(c, h, !0),
        "function" != typeof c[Le] && A(c, Le, De)),
        l && y && "values" !== y.name && (p = !0,
        v = function() {
            return y.call(this)
        }
        ),
    ...
    function(t, e) {
        var r, n, o = String(C(t)), i = G(e), s = o.length;
    ...
    var Be = function(t, e) {
      ...
      , Ce = Ie(Array, "Array", function(t, e) {
        ...
        Be(1)) : Be(0, "keys" == e ? r : "values" == e ? t[r] : [r, t[r]])
    }, "values");
    ...
    for (var Ue = $("iterator"), Me = $("toStringTag"), ze = Ae.Array, Ge = {
        ...
        var Ve, qe = We[He], Ke = Ge[qe], $e = h[qe], Je = $e && $e.prototype;
        if (Je && (Je[Ue] || A(Je, Ue, ze),
        Je[Me] || A(Je, Me, qe),
        Ae[qe] = ze,
        Ke))
            for (Ve in Ce)
                Je[Ve] || F(Je, Ve, Ce[Ve], !0)
    }
    Tt.f("iterator");
    ...
    function Xe(t, e) {
        ...
        for (var r in e)
            e.hasOwnProperty(r) && (t[r] = Xe(t[r], e[r]));
        return t
    }
    function Qe(t, e, r) {
        t[e] = r
    ...
    var rr = function() {
        ...
        return t.prototype.create = function(t, e) {
            void 0 === e && (e = {});
            var r, n = this.errors[t], o = this.service + "/" + t;
    ...
    !function(t) {
        ...
        e.prototype.compress_ = function(t, e) {
            ...
            if ("string" == typeof t)
                for (var n = 0; n < 16; n++)
                    r[n] = t.charCodeAt(e) << 24 | t.charCodeAt(e + 1) << 16 | t.charCodeAt(e + 2) << 8 | t.charCodeAt(e + 3),
                    e += 4;
            else
                for (n = 0; n < 16; n++)
                    r[n] = t[e] << 24 | t[e + 1] << 16 | t[e + 2] << 8 | t[e + 3],
                    e += 4;
            for (n = 16; n < 80; n++) {
                var o = r[n - 3] ^ r[n - 8] ^ r[n - 14] ^ r[n - 16];
                r[n] = 4294967295 & (o << 1 | o >>> 31)
            }
            var i, s, a = this.chain_[0], u = this.chain_[1], c = this.chain_[2], f = this.chain_[3], h = this.chain_[4];
            for (n = 0; n < 80; n++) {
                n < 40 ? n < 20 ? (i = f ^ u & (c ^ f),
                s = 1518500249) : (i = u ^ c ^ f,
                s = 1859775393) : n < 60 ? (i = u & c | f & (u | c),
                s = 2400959708) : (i = u ^ c ^ f,
                s = 3395469782);
    ...
    var or = function() {
        ...
        t.prototype.subscribe = function(t, e, r) {
            ...
            void 0 === n.error && (n.error = ir),
            void 0 === n.complete && (n.complete = ir);
    ...
    var sr = function(t, e) {
      ...
      , cr = function() {
        function t(t, e, r) {
            ...
            this.services_ = {},
            this.name_ = e.name,
            this._automaticDataCollectionEnabled = e.automaticDataCollectionEnabled || !1,
            this.options_ = Xe(void 0, t),
            this.INTERNAL = {
                getUid: function() {
                    return null
                },
        ...
        t.prototype.extendApp = function(t) {
            var e = this;
            Xe(this, t),
            t.INTERNAL && t.INTERNAL.addAuthTokenListener && (ur.forEach(function(t) {
          ...
          , o = {
            ...
            INTERNAL: {
                registerService: function(t, e, a, u, c) {
                    ...
                    var f = function(e) {
                        return void 0 === e && (e = i()),
                        "function" != typeof e[t] && fr("invalid-app-argument", {
                            name: t
                        }),
                        e[t]()
                    };
                    return void 0 !== a && Xe(f, a),
                    o[t] = f,
