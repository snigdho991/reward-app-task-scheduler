    ...
    !function() {
        ...
        !function() {
            function f() {
                ...
                return g && (g.version && (r.versions.fl = g.version),
                g.icTag && (r.icTag = g.icTag),
                r.siteToken = g.token),
                C && (r.lcp = C.lcp && void 0 !== C.lcp.value ? C.lcp : r.lcp,
                r.fid = C.fid && void 0 !== C.fid.value ? C.fid : r.fid,
                r.cls = C.cls && void 0 !== C.cls.value ? C.cls : r.cls),
                r
            }
            function d(r) {
                var o = l.timing
                ...
                if (void 0 == E) {
                    if ("function" == typeof l.getEntriesByType) {
                        ...
                        y && Array.isArray(y) && y.length > 0 && (p.timingsV2 = {},
                        p.versions.timings = 2,
                        delete p.timings,
                        u(y[0], p.timingsV2))
                    }
                    1 === p.versions.timings && u(o, p.timings),
                    u(a, p.memory)
                }
                if (p.documentWriteIntervention = n(),
                p.firstPaint = t("first-paint"),
                p.firstContentfulPaint = t("first-contentful-paint"),
                p.errorCount = window.__cfErrCount || 0,
                g && (g.icTag && (p.icTag = g.icTag),
                p.siteToken = g.token,
                R = !0),
                "function" == typeof l.getEntriesByType) {
                    ...
                    h.forEach(function(e) {
                        ...
                        w + n < 62e3 && p.tempResources ? (w += n,
                        p.tempResources[T].push(t)) : (T++,
                        w = 0)
                    })
                }
                return JSON.stringify(p).length >= 64e3 && (p.resources = []),
                void 0 !== E && (delete p.timings,
                delete p.memory,
                delete p.errorCount,
                delete p.documentWriteIntervention),
                p
            }
            ...
            if (!g || "single" !== g.load) {
                ...
                if (l && g && g.token) {
                    ...
                    document.addEventListener("visibilitychange", function() {
                        ...
                        "hidden" === document.visibilityState && !L && R && (L = !0,
                        F(k))
                    });
                    var C = {
                        lcp: void 0,
                      ...
                      , P = function(e) {
                        if (!e)
                            return "";
                        var t = e.localName;
                        return e.id && e.id.length > 0 && (t += "#" + e.id),
                        e.className && e.className.length > 0 && (t += "." + e.className.split(" ").join(".")),
                        t
                    }
                      , B = function(e) {
                        ...
                        if ("CLS" === e.name) {
                            ...
                            var n = O(e.entries);
                            n && (C.cls.element = P(n.node),
                            C.cls.currentRect = n.currentRect,
                            C.cls.previousRect = n.previousRect)
                        } else if ("FID" === e.name) {
                            C.fid = {
                                value: e.value,
                                path: t
                    ...
                    var k = g && (void 0 === g.spa || !0 === g.spa)
                      ...
                      , j = function(e) {
                        var t = function(e, t) {
                            ...
                            m.length > 3 && m.shift()),
                            (0,
                            o.sendObjectBeacon)("", n, function() {}, !1, A),
                            void 0 !== g.forward && void 0 !== g.forward.url && (0,
                            o.sendObjectBeacon)("", n, function() {}, !1, g.forward.url))
                        }
                          , n = d(e);
                        if (n && g) {
                            var r = n.tempResources;
                            if (delete n.tempResources,
                            k && r && 0 === r.length && t([], 0),
                            !r)
                                return;
                      ...
                      , F = function(e) {
                        ...
                        g && (0,
                        o.sendObjectBeacon)("", t, function() {}, !0, A)
                    }
                      , I = function() {
                        R = !0;
                    ...
                    function(t) {
                        ...
                        if (n) {
                            var r = function() {
                                v = c(),
                                "function" == typeof l.clearResourceTimings && l.clearResourceTimings()
                            };
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0,
    t.getTTFB = t.getLCP = t.getFID = t.getFCP = t.getCLS = void 0;
    var r, i, o, a, c = function(e, t) {
        ...
        var n, r = m(), i = c("FCP"), o = function(e) {
            "first-contentful-paint" === e.name && (u && u.disconnect(),
            e.startTime < r.firstHiddenTime && (i.value = e.startTime,
            i.entries.push(e),
            n(!0)))
        }, a = performance.getEntriesByName && performance.getEntriesByName("first-contentful-paint")[0], u = a ? null : s("paint", o);
        (a || u) && (n = d(e, i, t),
        a && o(a),
        f(function(r) {
            i = c("FCP"),
        ...
        var n, o = m(), l = c("FID"), p = function(e) {
            e.startTime < o.firstHiddenTime && (l.value = e.processingStart - e.startTime,
            l.entries.push(e),
            n(!0))
        }, v = s("first-input", p);
        n = d(e, l, t),
    ...
    }, O = new Set, _ = function(e, t) {
        var n, r = m(), i = c("LCP"), o = function(e) {
            var t = e.startTime;
        ...
        if (a) {
            n = d(e, i, t);
            var l = function() {
                O.has(i.id) || (a.takeRecords().map(o),
                a.disconnect(),
                O.add(i.id),
                n(!0))
            };
